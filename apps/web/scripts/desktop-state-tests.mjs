...
const desktopStateSpecs = [
	...
	"scripts/check-desktop-bundle-size.spec.mjs",
	...
	"src/components/agent-page/agent-chat-message-focus-contract.spec.ts",
	"src/components/agent-page/chat/agent-clear-session-state.spec.ts",
	"src/components/agent-page/chat/agent-ui-directive-state.spec.ts",
	...
	"src/components/agent-page/chat/knowledge-return-anchor.spec.ts",
	"src/components/agent-page/chat/message-focus-restoration.spec.ts",
	"src/components/agent-page/chat/message-source-state.spec.ts",
	"src/components/agent-page/chat/selection-toolbar-state.spec.ts",
	...
	"src/components/agent-page/chat/stop-reason-notice.spec.ts",
	...
	"src/components/ui/theme-provider.spec.ts",
	...
	"src/components/workspace/file-tree-editor/editor-save-contract.spec.ts",
	"src/components/workspace/file-tree-editor/markdown-source-decorations.spec.ts",
	"src/components/workspace/file-tree-editor/knowledge-editor-safety.spec.mjs",
	"src/components/workspace/file-tree-editor/univer-slides-runtime.spec.ts",
	...
	"src/kernel/session/connection-readiness.spec.ts",
	"src/kernel/session/connection-subscription-flow.spec.ts",
	...
	"src/kernel/session/run-verdict-flow.spec.ts",
	"src/kernel/session/session-runtime-busy-state.spec.ts",
	"src/kernel/session/session-status-normalization.spec.ts",
	"src/kernel/session/session-status-request-state.spec.ts",
	...
	"src/lib/llm-model-limits.spec.ts",
	"src/lib/markdown-outline.spec.ts",
	"src/lib/native-loopback-http.spec.ts",
	"src/contexts/history-navigation-keyguard.spec.ts",
	...
	"src/models/settings-startup-seed-contract.spec.ts",
...
const missingSpecs = desktopStateSpecs.filter(
	(spec) => !existsSync(join(packageRoot, spec)),
);
...
console.log(
	`[desktop-state-test] running ${desktopStateSpecs.length} desktop/agent state specs`,
);
...
child.on("error", (error) => {
	console.error(
		`[desktop-state-test] failed to start Node test runner: ${formatError(error)}`,
	);
	process.exitCode = 1;
});
