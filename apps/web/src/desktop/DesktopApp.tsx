...
import { desktopRuntime, initializeDesktopRuntimeGateway } from "./runtime";

async function bootstrapDesktopApp() {
	await initializeDesktopRuntimeGateway();
	...
	function formatStartupReason(reason: unknown) {
		...
		if (typeof reason === "object" && reason && "message" in reason) {
			return String(
				(reason as { message?: unknown }).message ?? "Unknown error",
			);
		}
