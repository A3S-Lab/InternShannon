          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              {state.modalProps?.description && (
                <AlertDialogDescription>{state.modalProps?.description}</AlertDialogDescription>
              )}
            </AlertDialogHeader>
            <AlertDialogFooter>
              <AlertDialogCancel
        ...
        <Dialog open={state.open} onOpenChange={(open) => (state.open = open)}>
          <DialogContent>
            <DialogHeader>
              ...
              {state.modalProps?.description && <DialogDescription>{state.modalProps?.description}</DialogDescription>}
            </DialogHeader>
            <DialogFooter>
              <Button
                onClick={async () => {
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              {state.promptProps?.description && (
                <AlertDialogDescription>{state.promptProps?.description}</AlertDialogDescription>
              )}
            </AlertDialogHeader>
            <PromptInput
...
export const useModal = () => {
  ...
  if (context === undefined) throw new Error("useModal must be used within a ModalProviderContext");
