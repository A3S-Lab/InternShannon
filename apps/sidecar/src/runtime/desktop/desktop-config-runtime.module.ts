...
import { AclConfigService } from '@/modules/config/infrastructure/desktop/acl-config/acl-config.service';
...
import { ConfigController } from '@/modules/config/presentation/controllers/config.controller';
import { ConfigEntryController } from '@/modules/config/presentation/controllers/config-entry.controller';
import { ConfigPublicController } from '@/modules/config/presentation/controllers/config-public.controller';
import { PluginsController } from '@/modules/config/presentation/controllers/plugins.controller';
import { ConfigSettingsValidationService } from '@/modules/config/presentation/validators/config-settings-validation.service';
import { DesktopConfigCategoryController } from '@/modules/config/presentation/controllers/desktop-config-category.controller';
