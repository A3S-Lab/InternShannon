...
import { DesktopKernelService } from '@/infrastructure/desktop/kernel/desktop-kernel.service';
import { DesktopMessageRepository } from '@/infrastructure/desktop/kernel/desktop-message.repository';
import { DesktopSessionRepository } from '@/infrastructure/desktop/kernel/desktop-session.repository';
