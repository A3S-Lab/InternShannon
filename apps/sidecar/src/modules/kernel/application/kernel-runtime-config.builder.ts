...
export class KernelRuntimeConfigBuilder {
    ...
    private responseGuards(): string {
        ...
        return [
            ...
            '- For generated data or mechanical file contents larger than roughly 200 lines, 100 records, or 20 KB, do not stream the final artifact through a large inline write argument. Create a small generator script in the workspace and run it, or use a true batch edit/transform that keeps large generated data out of tool parameters. A single huge write is not a batch edit.',
